...
namespace NewGraph {
    ...
    public class NodeAttribute : Attribute {
        ...
        public NodeAttribute(string color = null, string categories = "", string inputPortName = null, Port.Capacity inputPortCapacity = Port.Capacity.Multi, string nodeName = null, bool createInputPort = true) {
            if (color != null) {
